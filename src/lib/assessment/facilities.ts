...
const CATEGORY_LABELS: Record<FacilityCategory, string> = {
  elementary_school: 'Nearest Public Elementary School',
  secondary_school: 'Nearest Public Secondary School',
  govt_health: 'Nearest Government Health Facility',
  private_health: 'Nearest Private Health Facility',
  primary_road: 'Nearest Primary Road Network',
  secondary_road: 'Nearest Secondary Road Network',
}
